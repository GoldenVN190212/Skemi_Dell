...
class AINotebookController {
    ...
    async checkModelSystem() {
        try {
            ...
            this.showNotification('⚠️ Không thể kết nối server, dùng chế độ giả lập', 'warning');
        }
    }
    ...
    setupLayout() {
        ...
        if (dashboardContent) {
            // Replace dashboard content with AI Notebook
    ...
    getNotebookHTML() {
            ...
            <div class="ai-notebook-section" id="notebook-section">
                <div class="notebook-container">
                    ...
                    <div class="notebook-files-panel">
                        <h3 data-i18n="dashboard.files.title">📁 Files & Analysis</h3>
                        <div class="notebook-upload-area" id="uploadArea">
                            <div class="upload-icon">📤</div>
                            <p data-i18n="dashboard.upload.area">Drop files here or click to browse</p>
                        ...
                        <div class="diagram-type-selector">
                            <div class="diagram-type-card selected" data-type="mindmap">
                                ...
                                <div class="diagram-desc" data-i18n="dashboard.diagram.mindmap.desc">Sơ đồ tư duy</div>
                            </div>
                            <div class="diagram-type-card" data-type="flowchart">
                                ...
                                <div class="diagram-desc" data-i18n="dashboard.diagram.flowchart.desc">Sơ đồ luồng</div>
                            </div>
                            <div class="diagram-type-card" data-type="chart">
                                <div class="diagram-icon">📈</div>
                                <div class="diagram-title" data-i18n="dashboard.diagram.chart">Chart</div>
                                <div class="diagram-desc" data-i18n="dashboard.diagram.chart.desc">Biểu đồ & Đồ thị</div>
                            </div>
                            <div class="diagram-type-card" data-type="timeline">
                                <div class="diagram-icon">📅</div>
                                <div class="diagram-title" data-i18n="dashboard.diagram.timeline">Timeline</div>
                                <div class="diagram-desc" data-i18n="dashboard.diagram.timeline.desc">Dòng thời gian</div>
                            </div>
                        </div>
                    ...
                    <div class="notebook-canvas-panel">
                        <div class="canvas-toolbar">
                            <button class="toolbar-btn active" id="autoGenerateBtn" data-i18n="dashboard.canvas.toolbar.auto">🤖 AI Generate</button>
                            <button class="toolbar-btn" id="manualDrawBtn" data-i18n="dashboard.canvas.toolbar.manual">✏️ Manual Draw</button>
                            <button class="toolbar-btn" id="exportBtn" data-i18n="dashboard.canvas.toolbar.export">💾 Export</button>
                            <button class="toolbar-btn" id="clearBtn" data-i18n="dashboard.canvas.toolbar.clear">🗑️ Clear</button>
                        </div>
                    ...
                    <div class="notebook-chat-panel">
                        <div class="chat-header">
                            <span data-i18n="dashboard.chat.title">💬 AI Assistant</span>
                            <button class="search-toggle" id="searchToggle" data-i18n="dashboard.chat.search.toggle">🔍 Search Web</button>
                        </div>
                        <div class="chat-messages" id="chatMessages">
                            <div class="notebook-message ai">
                                <p data-i18n="dashboard.chat.welcome">Xin chào! Tôi là AI Assistant của Skemi. Upload file và tôi sẽ giúp bạn phân tích và tạo các sơ đồ, biểu đồ chuyên nghiệp.</p>
                            </div>
                        </div>
                        <div class="chat-input-area">
                            <div class="chat-input-container">
                                <textarea 
                                    ...
                                    rows="1"
                                ></textarea>
                                <button class="chat-send-btn" id="chatSendBtn" data-i18n="dashboard.chat.send">➤</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        const dashboardContent = document.getElementById('dashboard-content');
        if (dashboardContent) {
            dashboardContent.innerHTML = notebookHTML;
        }
    }
...
document.addEventListener('DOMContentLoaded', () => {
    // Initialize AI Notebook in Dashboard
    const dashboardContent = document.getElementById('dashboard-content');
    if (dashboardContent) {
